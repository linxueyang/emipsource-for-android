...
Ext.define('YZSoft.form.field.PopupRadioList', {
    extend: 'YZSoft.src.field.PopupRadioList',
    mixins: [
    ...
    updateValue: function (newValue, oldValue) {
        ...
        if (row && datamap) {
            mdata = me.record ? Ext.apply({}, me.record.data, me.record.raw) : {};
            row.doMap(mdata, datamap);
        }
    },
