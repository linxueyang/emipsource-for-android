...
//    private static final int CAPTURE_INVALID_ARGUMENT = 2;
    ...
    //>>1<<
    private boolean successEnterRight = false;
...
//    }
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
		...
		//>>1<<
		this.successEnterRight = options.optBoolean("successEnterRight", false);
    ...
    public void onActivityResult(int requestCode, int resultCode, final Intent intent) {
        ...
        if (resultCode == Activity.RESULT_OK) {
					//>>1<<
					if (that.successEnterRight)
		    			that.cordova.getActivity().overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
